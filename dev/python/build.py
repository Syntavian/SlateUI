...
def build_app(_path: str = "./") -> None:
    ...
    compress_transfer_css(
        _path + CSS_PREBUILD_DIR + "/style.css", _path + SLATE_DIR + "/slate.css"
    )
    ...
    transfer("./dev/js/lib/lib.js", _path + SLATE_DIR + "/slate.js")

    # Create the public app CSS using the discovered CSS selectors
    build_css(_path + SLATE_DIR, _path + CSS_OUT_DIR, style_selectors)
