...
SIGNATURE: dict[str, list[str]] = {
    ...
    r".\dev\js": ['button_styles.js', 'css_utils.js', 'css_utils.test.js', 'image_styles.js', 'layout_styles.js', 'main.js', 'scroll_styles.js', 'sticky_styles.js', 'theme_styles.js'],
    ...
    r".\dev\python\html_build\types": ['argument.py', 'component.py', 'page.py', 'tag.py', 'wrapper.py'],
    r".\dev\python\js_build": ['js_builder.py'],
    r".\dev\python\utils": ['console_utils.py', 'error_utils.py', 'file_utils.py', 'function_utils.py', 'html_utils.py', 'string_utils.py', 'test_file_utils.py', 'test_function_utils.py', 'test_html_utils.py', 'test_string_utils.py'],
